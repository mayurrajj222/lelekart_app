...
export default function CheckoutScreen({ navigation }) {
  ...
  const maxWalletUsage = Math.floor(finalTotal * 0.05); // 5% of order total
  ...
  const maxWallet = Math.min(walletBalance, maxWalletUsage);
        ...
        {!user ? (
          ...
          <>
            ...
            <View style={{ backgroundColor: CARD_BG, borderRadius: 10, padding: 14, marginBottom: 18, borderWidth: 1, borderColor: BORDER_COLOR, shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 4, elevation: 1 }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 6 }}>
                <Icon name="percent" size={18} color={TEXT_SECONDARY} style={{ marginRight: 8 }} />
                <Text style={{ color: TEXT_SECONDARY, fontSize: 13 }}>Maximum wallet usage: 5% of order total</Text>
                <Text style={{ color: TEXT_ACCENT, fontWeight: 'bold', fontSize: 13, marginLeft: 8 }}>₹{maxWalletUsage}</Text>
              </View>
            </View>
            ...
            <View style={{ backgroundColor: CARD_BG, borderRadius: 10, padding: 12, marginBottom: 16, borderWidth: 1, borderColor: BORDER_COLOR }}>
              ...
              <Text style={{ color: TEXT_SECONDARY, fontSize: 12, marginBottom: 8 }}>You can use up to 5% of your order total (₹{maxWalletUsage}) from your wallet</Text>
              <TextInput
                ...
                placeholder={`Enter wallet amount to use (max ₹${maxWallet})`}
