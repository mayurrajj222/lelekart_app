        ...
        <div className="max-w-6xl mx-auto mt-8">
          ...
          <Tabs defaultValue="profile" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-8">
              ...
              <TabsTrigger value="affiliate" className="text-lg font-medium">
                Affiliate Dashboard
              </TabsTrigger>
            </TabsList>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="shadow-sm bg-[#F8F5E4]">
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>
                      Your affiliate earnings overview
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
            ...
            <TabsContent value="affiliate" className="space-y-6">
              <div className="mb-6">
                <h2 className="text-2xl font-bold mb-2">Affiliate Dashboard</h2>
                <p className="text-muted-foreground">
                  Welcome, {affiliate.name}! Here you can track your affiliate
                  code usage.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <Card className="shadow-sm bg-[#F8F5E4]">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg">Code Uses</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Total times your code was used
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="shadow-sm bg-[#F8F5E4]">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg">Discount Rate</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="text-center">
              ...
              {/* Your Affiliate Code */}
              <Card className="mb-8 shadow-sm bg-[#F8F5E4]">
                <CardHeader>
                  <CardTitle className="text-xl">Your Affiliate Code</CardTitle>
                  <CardDescription>
                ...
                <CardContent>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                    <div className="flex-1">
                      ...
                      <span className="text-2xl font-mono bg-gray-100 px-4 py-2 rounded border-2 border-gray-300">
                        {affiliate.code}
                      </span>
                    </div>
                    <div className="flex gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <span className="text-lg">{affiliate.usageCount}</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  {orders.length === 0 ? (
                    <div className="text-center text-muted-foreground py-12">
                      ...
                      <p className="text-sm">
                        When customers use your affiliate code, their orders
                        will appear here.
                      </p>
                    </div>
                  ) : (
